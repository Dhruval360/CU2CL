...
int __cu2cl_Kernel_remove_redness_from_coordinates_temp_arg_50 = 40;
err = clSetKernelArg(__cu2cl_Kernel_remove_redness_from_coordinates, 5, sizeof(int), &__cu2cl_Kernel_remove_redness_from_coordinates_temp_arg_50);
...
int __cu2cl_Kernel_remove_redness_from_coordinates_temp_arg_81 = 9;
err = clSetKernelArg(__cu2cl_Kernel_remove_redness_from_coordinates, 8, sizeof(int), &__cu2cl_Kernel_remove_redness_from_coordinates_temp_arg_81);
/*printf("clSetKernelArg for argument 8 of kernel __cu2cl_Kernel_remove_redness_from_coordinates: %s\n", getErrorString(err));//Uncomment this for getting error string of the error code returned by clSetKernelArg*/
int __cu2cl_Kernel_remove_redness_from_coordinates_temp_arg_92 = 9;
err = clSetKernelArg(__cu2cl_Kernel_remove_redness_from_coordinates, 9, sizeof(int), &__cu2cl_Kernel_remove_redness_from_coordinates_temp_arg_92);
