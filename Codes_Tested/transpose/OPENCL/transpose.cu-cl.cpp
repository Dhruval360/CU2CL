...
void __cu2cl_Init_transpose_cu() {
    ...
    //printf("clCreateProgramWithBinary for transpose.cu-cl.cl: %s\n", getErrorString(err));
    #else
...
//printf("clCreateBuffer for device variable d_in: %s\n", getErrorString(err));
	d_out = clCreateBuffer(__cu2cl_Context, CL_MEM_READ_WRITE, numbytes, NULL, &err);
//printf("clCreateBuffer for device variable d_out: %s\n", getErrorString(err));
...
/*printf("clSetKernelArg for argument 0 of kernel __cu2cl_Kernel_transpose_serial: %s\n", getErrorString(err));//Uncomment this for getting error string of the error code returned by clSetKernelArg*/
err = clSetKernelArg(__cu2cl_Kernel_transpose_serial, 1, sizeof(cl_mem), &d_out);
/*printf("clSetKernelArg for argument 1 of kernel __cu2cl_Kernel_transpose_serial: %s\n", getErrorString(err));//Uncomment this for getting error string of the error code returned by clSetKernelArg*/
localWorkSize[0] = 1;
globalWorkSize[0] = (1)*localWorkSize[0];
...
/*printf("clSetKernelArg for argument 0 of kernel __cu2cl_Kernel_transpose_parallel_per_element: %s\n", getErrorString(err));//Uncomment this for getting error string of the error code returned by clSetKernelArg*/
err = clSetKernelArg(__cu2cl_Kernel_transpose_parallel_per_element, 1, sizeof(cl_mem), &d_out);
/*printf("clSetKernelArg for argument 1 of kernel __cu2cl_Kernel_transpose_parallel_per_element: %s\n", getErrorString(err));//Uncomment this for getting error string of the error code returned by clSetKernelArg*/
...
/*printf("clSetKernelArg for argument 0 of kernel __cu2cl_Kernel_transpose_parallel_per_element_tiled: %s\n", getErrorString(err));//Uncomment this for getting error string of the error code returned by clSetKernelArg*/
err = clSetKernelArg(__cu2cl_Kernel_transpose_parallel_per_element_tiled, 1, sizeof(cl_mem), &d_out);
/*printf("clSetKernelArg for argument 1 of kernel __cu2cl_Kernel_transpose_parallel_per_element_tiled: %s\n", getErrorString(err));//Uncomment this for getting error string of the error code returned by clSetKernelArg*/
localWorkSize[0] = threads[0];
localWorkSize[1] = threads[1];
localWorkSize[2] = threads[2];
globalWorkSize[0] = blocks[0]*localWorkSize[0];
...
/*printf("clSetKernelArg for argument 0 of kernel __cu2cl_Kernel_transpose_parallel_per_element_tiled16: %s\n", getErrorString(err));//Uncomment this for getting error string of the error code returned by clSetKernelArg*/
err = clSetKernelArg(__cu2cl_Kernel_transpose_parallel_per_element_tiled16, 1, sizeof(cl_mem), &d_out);
/*printf("clSetKernelArg for argument 1 of kernel __cu2cl_Kernel_transpose_parallel_per_element_tiled16: %s\n", getErrorString(err));//Uncomment this for getting error string of the error code returned by clSetKernelArg*/
...
/*printf("clSetKernelArg for argument 0 of kernel __cu2cl_Kernel_transpose_parallel_per_element_tiled_padded16: %s\n", getErrorString(err));//Uncomment this for getting error string of the error code returned by clSetKernelArg*/
err = clSetKernelArg(__cu2cl_Kernel_transpose_parallel_per_element_tiled_padded16, 1, sizeof(cl_mem), &d_out);
/*printf("clSetKernelArg for argument 1 of kernel __cu2cl_Kernel_transpose_parallel_per_element_tiled_padded16: %s\n", getErrorString(err));//Uncomment this for getting error string of the error code returned by clSetKernelArg*/
localWorkSize[0] = threads16x16[0];
localWorkSize[1] = threads16x16[1];
localWorkSize[2] = threads16x16[2];
globalWorkSize[0] = blocks16x16[0]*localWorkSize[0];
