...
extern cl_kernel __cu2cl_Kernel_sharpeningFilter;
extern cl_program __cu2cl_Program_Parallel_gpu_cu;
const char *progSrc;
size_t progLen;
...
//printf("Creation of main command queue is: %s", getErrorString(err));
    __cu2cl_Init_Parallel_gpu_cu();
}

void __cu2cl_Cleanup() {
    __cu2cl_Cleanup_Parallel_gpu_cu();
