...
extern cl_kernel __cu2cl_Kernel_medianFilter;
extern cl_program __cu2cl_Program_Median_Filter_cu;
extern cl_int err;
const char *progSrc;
size_t progLen;
...
//printf("Creation of main command queue: %s\n", getErrorString(err));
    __cu2cl_Init_Median_Filter_cu();
}

void __cu2cl_Cleanup() {
    __cu2cl_Cleanup_Median_Filter_cu();
