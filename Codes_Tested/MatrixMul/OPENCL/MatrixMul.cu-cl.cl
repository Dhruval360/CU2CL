...
Note:
    ...
    further sppedup can be obtained by /*CU2CL Warning: using namespace not allowed in the OpenCL Kernel File*/ 
 // using shared memory to decrease global memory access times
return: none
*********************************************************************
*/
