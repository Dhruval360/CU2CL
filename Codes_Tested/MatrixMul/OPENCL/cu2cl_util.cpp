...
extern cl_kernel __cu2cl_Kernel_gpu_matrix_mult;
extern cl_kernel __cu2cl_Kernel_gpu_square_matrix_mult;
extern cl_kernel __cu2cl_Kernel_gpu_matrix_transpose;
extern cl_program __cu2cl_Program_MatrixMul_cu;
extern cl_int err;
const char *progSrc;
size_t progLen;
...
//printf("Creation of main command queue: %s\n", getErrorString(err));
    __cu2cl_Init_MatrixMul_cu();
}

void __cu2cl_Cleanup() {
    __cu2cl_Cleanup_MatrixMul_cu();
